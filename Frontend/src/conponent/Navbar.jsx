...
// console.log(visible)
const {setshow,getCartCount} = useContext(ShopContext)
  return (
   ...
   <p className='absolute top-10  bg-red-500 text-white rounded-full w-5 h-5 flex items-center justify-center' >{getCartCount()}</p>
   </Link>
